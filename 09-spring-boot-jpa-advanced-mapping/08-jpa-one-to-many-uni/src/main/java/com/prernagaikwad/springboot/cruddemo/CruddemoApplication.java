...
import com.prernagaikwad.springboot.cruddemo.Entity.Review;
...
public class CruddemoApplication {
    ...
    private void findInstrutcorWithCoursesJoinFetch(AppDAO appDAO)
    {
        int theId =1;
        // find the instructor
        System.out.println("Finding instructor id: " +theId);
        ...
        System.out.println("The associated courses:" + tempInstructor);
        System.out.println("Done!");
